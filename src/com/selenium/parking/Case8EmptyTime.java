...
public class Case8EmptyTime extends junit.framework.TestCase{
  ...
  public void testCase8EmptyDateOrTime() throws Exception {
    ...
    driver.findElement(By.id("EntryTime")).sendKeys("");
    ...
    driver.findElement(By.id("ExitTime")).sendKeys("");
    ...
    try {
      ...
      verificationErrors.append("Form did not properly handle empty time values. ");
      verificationErrors.append(e.toString());
    }
    
    // This is an error message designed by me that should be displayed if the time field is empty.
//    try {
//      assertEquals("ERROR! YOUR ENTRY TIME OR EXIT TIME IS EMPTY", driver.findElement(By.cssSelector("b")).getText());
//    } catch (Error e) {
//      verificationErrors.append(e.toString());
//    }
  }
