...
public class Case5NegativeHours extends junit.framework.TestCase{
  ...
  public void testCase5InvalidHours() throws Exception {
    ...
    //Set entry and exit times to negative values.
    ...
    try {
      assertThat("(0 Days, 1 Hours, 0 Minutes)", is(not(driver.findElement(By.cssSelector("span.BodyCopy > font > b")).getText().trim())));
    } catch (Error e) {
      verificationErrors.append("Form did not properly handle negative time values. ");
